...
public class RetrCommandTests
{
    ...
    public RetrCommandTests()
    {
        _context = new FtpCommandContext(_session, "RETR", "file.txt", _fileSystem, _authenticator, new(), NullLogger.Instance);
